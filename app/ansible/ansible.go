...
// 				{name: "tag2"},
// 			},
// 			password_file_path: "/path/to/password_file1.txt",
// 		},
// 		{
// 			name:  "Playbook 2",
// 			path: "/path/to/playbook1.yml",
// 			inventory: inventory{
// 				name: "Inventory 1",
// 				path: "/path/to/inventory1.ini",
// 			},
// 			tags: []tag{
// 				{name: "tag1"},
// 				{name: "tag2"},
...
// 			Title("What playbook do you want to run?").
// 			Options(
// 				huh.NewOption(playbooks[0].name, playbooks[0].name),
// 				huh.NewOption(playbooks[1].name, playbooks[1].name),
// 			).
// 			Value(&name),
// 		),
// 	)
